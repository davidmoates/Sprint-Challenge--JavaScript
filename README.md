...
- Method is object specific and function on can stand alone.

3. What is closure?

- Closures are functions that refer to free variables. It helps remember data.
...
- It is so we can use the `this` keyword and it refer to child of the parent and not the parent.
